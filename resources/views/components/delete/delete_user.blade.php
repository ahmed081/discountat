    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3">Delete User</h5>
                <button type="button"  class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="users/desable/{{$user->id}}" method="POST">
                @csrf
                <div class="modal-body">
                    
                        <div>
                            <p>
                                Deleting this user will not remove all the imforamtion from our database.
                                <br>
                                ps : You can undo it by enabling the user
                            </p>
                        </div>
